            ...
            >
              <CardContent className="pt-6">
                <div className="flex items-start gap-4">
                  <div className={`p-3 rounded-xl ${isCompleted ? "bg-brand/20" : "bg-zinc-800"}`}>
                    <Icon className={`w-6 h-6 ${isCompleted ? "text-brand" : "text-zinc-400"}`} />
                  </div>
